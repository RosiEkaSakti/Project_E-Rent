...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-arrow-circle-o-right"></i>Tambah Data Transaksi E-RENT
                </li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
                       ...
                       <form action="<?php base_url('transaksibiaya/c_transaksibiaya/add') ?>" method="post" enctype="multipart/form-data" >
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('tgl_sewa') ? 'is-invalid':'' ?>"
                                 type="number" name="tgl_sewa" placeholder="tgl_sewa" value="<?= $v_transaksibiaya->id_biayatransaksi ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('id_mobil') ? 'is-invalid':'' ?>"
                                 type="file" name="id_mobil" min="0" placeholder="id_mobil" value="<?= $v_transaksibiaya->id_mobil ?>" />
                                <div class="invalid-feedback">
                                    <?php echo form_error('id_transaksibiaya') ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('no_ktp') ? 'is-invalid':'' ?>"
                                 type="tetxt" name="no_ktp" placeholder="no_ktp" value="<?= $v_transaksibiaya->no_ktp?>" />
                                <div class="invalid-feedback">
