...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-arrow-circle-o-right"></i>Edit Pengembaliann E-RENT
                </li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
                       ...
                       <form action="<?php base_url('pengembalian/c_pengembalian/add') ?>" method="post" enctype="multipart/form-data" >
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('id_pengembalian') ? 'is-invalid':'' ?>"
                                 type="number" name="id_pengembalian" placeholder="id_pengembalian" value="<?= $v_pengembalian->id_pengembalian ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('harga') ? 'is-invalid':'' ?>"
                                 type="tetxt" name="harga" placeholder="harga" value="<?= $v_pengembalian->harga?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('terlambat') ? 'is-invalid':'' ?>"
                                 type="text" name="terlambat" placeholder="terlambat"value="<?= $v_pengembalian->terlambat ?>" />
                                <div class="invalid-feedback">
